...
test:
	...
	dfx canister update-settings threshold --add-controller rrkah-fqaaa-aaaaa-aaaaq-cai
	dfx canister call threshold test_reinstall
	sleep 1
	dfx canister call threshold --query get
	dfx canister call threshold inc
	dfx canister call threshold --query get
	...
	echo id: $(shell dfx canister id threshold)
	echo principal: $(shell dfx identity get-principal)
	dfx canister update-settings threshold --add-controller rrkah-fqaaa-aaaaa-aaaaq-cai $(shell dfx canister id threshold)
